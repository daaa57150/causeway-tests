...
@Table(
        ...
        name = "Person",
        uniqueConstraints = {
                @UniqueConstraint(name = "PersonObject__name__UNQ", columnNames = {"name"})
        }
)
...
//    private int version;
    ...
    public PersonObject(final String name) {
        this.name = name;
    }
...
//    }
    ...
    @Override
    public int compareTo(final PersonObject other) {
        return Comparator.comparing(PersonObject::getName).compare(this, other);
    }
